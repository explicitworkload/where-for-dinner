...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=explicitworkload&repo=where-for-dinner",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=explicitworkload&repo=where-for-dinner","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6614371956271383047, --data-values-file, /tmp/accelerator-options14931384728302013731.json, --output-files, /tmp/ytt-output5929238498132307966]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=explicitworkload&repo=where-for-dinner'
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=explicitworkload&repo=where-for-dinner","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input3384908477296743105, --data-values-file, /tmp/accelerator-options12190919010178831108.json, --output-files, /tmp/ytt-output11013236881521086832]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=explicitworkload&repo=where-for-dinner","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15123144702403916658, --data-values-file, /tmp/accelerator-options8459669920751142726.json, --output-files, /tmp/ytt-output2224354389172052874]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=explicitworkload&repo=where-for-dinner","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input9476974514837736675, --data-values-file, /tmp/accelerator-options14180233244016453233.json, --output-files, /tmp/ytt-output10261793108931528225]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=explicitworkload&repo=where-for-dinner","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input9193869939830563406, --data-values-file, /tmp/accelerator-options16409659849466576831.json, --output-files, /tmp/ytt-output3716999251207508481]
